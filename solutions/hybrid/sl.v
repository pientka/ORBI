...
inversion h0; subst.
assert (i=i0); try omega; subst; clear H.
apply H2; auto.
Qed.
...
replace (i+1+j) with (i+j+1); try omega.
apply s_imp; auto.
apply H with a0; auto; try omega.
